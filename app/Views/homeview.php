                            ...
                            <div class="col-lg-12 d-lg-block" style="text-align: center;">
                                ...
                                <div class="card">
                                    <div class="card-header" style="color: black">
                                        <strong>RECENT UPLOADED BOOKS</strong>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php if(!empty($recentup)): ?>
                                                    <?php foreach($recentup as $rec) : ?>
                                                        <tr>
                                                            <td style="color: black">
                                                                <a href="#" data-toggle="modal" data-target="#viewModal<?= $rec['bookid']; ?>" style="color: black; text-decoration: none;">
                                                                    <img src="<?= $rec['image']; ?>" alt="bookcover" height="90px">
                                                                </a>
                                                            </td>
                                                            <td style="color: black; text-align: left;">
                                                                <a href="#" data-toggle="modal" data-target="#viewModal<?= $rec['bookid']; ?>" style="color: black; text-decoration: none;">
                                                                    <strong><?= $rec['title']; ?></strong> - <?= $rec['edition']; ?><br>
                                                                    <span><?= $rec['authors']; ?></span><br>
                                                                    <span><?= $rec['isbn']; ?></span><br>
                                                                    <span>
                                                                    <span style="font-size: 13px;">
                                                                        <?php foreach ($catlist as $catl): ?>
                                                                            <?php $catlid = $catl['catid']; ?>
                                                                            <?php if($catlid == $rec['bookcatid']) : ?>
                                                                                <?= $catl['catname']; ?>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; ?>
                                                                    </span><br>
                                                            ...
                                                            <td style="color: black">
                                                                <a href="#" data-toggle="modal" data-target="#viewModal<?= $rec['bookid']; ?>" style="color: black; text-decoration: none;">
                                                                    <span><strong>COPIES: </strong></span><?= $rec['copies']; ?>pcs <br>
                                                            ...
                                                            <!-- Edit Modal-->
                                                            <div class="modal fade" id="viewModal<?= $rec['bookid']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                                aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="card-body" style="text-align: left">
                                                                            <?php foreach ($booklist as $books): ?>
                                                                                <?php if($books['bookid'] === $rec['bookid']): ?>
