                        ...
                        <?php echo form_open(); ?>
                            <div class="form-group">
                                <input type="text" name="position" class="form-control form-control-user"
                                    placeholder="ENTER POSITION" style="color: black">
                            </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($pos as $position): ?>
                                            <tr>
                                                <td style="color: black">P-<?php echo $position['posid']; ?></td>
                                                <td style="color: black"><?php echo $position['posname']; ?></td>
                                                <td style="text-align: center">
                                                    <button class="btn btn-info btn-icon-split btn-sm" title="Edit"
                                                    href="#" data-toggle="modal" data-target="#editModal<?= $position['posid']; ?>">
                                                        <span class="icon" style="font-size: 10px">
                                                            <i class="fas fa-edit"></i>
                                                        </span>
                                                    </button>
                                                    <!-- Edit Modal-->
                                                    <div class="modal fade" id="editModal<?= $position['posid']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <?php echo form_open('position/update/'.$position['posid']); ?>
                                                                <div class="modal-body" style="text-align: left">
                                                                    <div class="form-group">
                                                                        <input type="text" name="name" class="form-control form-control-user"
                                                                            value="<?php echo $position['posname']; ?>" style="color: black">
                                                                    </div>
                                                    ...
                                                    onclick="window.location.href='<?= base_url(); ?>position/delete/<?= $position['posid']; ?>';">
                                                        <span class="icon" style="font-size: 10px">
